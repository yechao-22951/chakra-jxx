...
js::value_ref_t jello() { return nullptr; }
...
class Console : public JxxClassTemplate<Console, IJxxObject> {
  ...
  public:
    js::value_ref_t log(js::more_list_ args) { return JS_INVALID_REFERENCE; }
...
int main() {
    ...
    js::ExternalObject xobj =
        js::ExternalObject::Create(new Console, JS_INVALID_REFERENCE);
    logf.Call(xobj);
