...
namespace js {
    ...
    public:
        ...
        JsValueRef get() const { return nake_; }
        ...
        JsValueRef* address() { return &nake_; }

        JsValueRef* addr() { return &nake_; }

        value_ref_t* operator->() { return this; }
        uint32_t AddRef() {
            uint32_t rc = 0;
    ...
    public:
        ...
        value_ref_t value() const { return *(value_ref_t*)this; }
    };
    ...
    public:
        ...
        base_value_* operator->() { return this; }
        uint32_t AddRef() {
            if (!Accessor_::get())
                return 0;
            uint32_t rc = 0;
